...
//  Twitty
//
//  Created by Lia Zadoyan on 10/8/17.
...
class UserTweetsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, TweetCellDelegate, IndicatorInfoProvider {
